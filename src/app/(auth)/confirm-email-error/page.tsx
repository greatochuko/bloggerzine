...
export const metadata: Metadata = { title: "Error Confirmimg Email" };
  ...
  return (
    <div className={styles["confirm-email-page"]}>
      <div className={styles["container"]}>
        ...
        <p>
          The verification link sent to <strong>{email}</strong> has expired
        </p>
        <p>
          Click on the link below to re-send the verification email to complete
          your signup.
        </p>
